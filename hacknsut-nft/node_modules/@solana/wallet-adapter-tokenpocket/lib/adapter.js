...
import { BaseMessageSignerWalletAdapter, pollUntilReady, WalletAccountError, WalletConnectionError, WalletNotConnectedError, WalletNotFoundError, WalletNotInstalledError, WalletPublicKeyError, WalletSignTransactionError, } from '@solana/wallet-adapter-base';
...
export class TokenPocketWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    get ready() {
        var _a;
        return typeof window !== 'undefined' && !!((_a = window.solana) === null || _a === void 0 ? void 0 : _a.isTokenPocket);
    }
    get connecting() {
